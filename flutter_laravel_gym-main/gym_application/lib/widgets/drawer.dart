// All the screens of the application are defined in the following drawer class
// Side nav used to navigate between the screens and different drawer tile are show according to thier role
