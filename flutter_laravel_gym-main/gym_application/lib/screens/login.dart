...
* this page is where the user can login to the app
* with the help of api call we can login the user from the backend
* and if the user is successfully logged in then he/she can access the app
* else he/she can't access the app
* Credentials Validation is also done here
* Token is also stored in the shared preferences for further use to access different api.
 */
import 'dart:ui';
