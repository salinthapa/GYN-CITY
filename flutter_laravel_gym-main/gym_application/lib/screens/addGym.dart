/**
* This is gym screen where admin can add gym.
* With the help of api call we can add gym from the backend.
 */
import 'dart:ui';
...
class _AddGymState extends State<AddGym> {
  ...
  void gymForm() async {
    ...
    var res = await CallApi().postDataWithToken(data, 'gyms', tokenString);
    var body = json.decode(res.body);
    if (body['status'] == 'success') {
      Navigator.pushReplacementNamed(context, '/gym');
    } else {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text('Gym cannot be added'),
