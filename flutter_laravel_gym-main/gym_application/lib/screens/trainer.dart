/**
* This is the trainer page of the app where
* user can see the list of trainer and can select the trainer.
* Admin can add or delete the trainer from thier panel but user can view only.
* Backend fetch all the user from the backend and list them by filtering trainer only
 */
