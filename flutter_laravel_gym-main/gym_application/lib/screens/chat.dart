/**
This shows the chat page in the application. this screen uses the chat model from before and with the chat model we can now use the chat model to get the data from the database and display it in the chat page.
it accepts different arguments from the previous screen and displays the chat page with the data from the database.
 */
import 'package:flutter/material.dart';
import 'package:socket_io_client/socket_io_client.dart';
import 'package:gymapplication/model/chart_model.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          backgroundColor: const Color(0x898c8a)),
      body: SafeArea(
        child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(
                  ...
                  softWrap: true,
                  style:
                      const TextStyle(color: Color(0xFE594097), fontSize: 14),
                ),
              ],
            ),
          ),
