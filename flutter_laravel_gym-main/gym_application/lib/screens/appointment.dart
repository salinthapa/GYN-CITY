/**
* This is Appointment list screen where user can see the list of appointments.
* User like customer and trainer can view, edit and cancel thier appointmnents
*/
