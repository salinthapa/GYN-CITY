/**
* this screen shows all the level of workout for the user.
* ALl the levels like intermediate, begineer and Advanced Level are shown in this page
* ALl levels lead to new week page where different exercises can be explored.
 */
