...
/**
 * Provider file is used to register the service provider.
 * This file is automatically generated.
 * it uses the ServiceProvider class to register the module.
 * it uses policies to define the access to the module.
 */
